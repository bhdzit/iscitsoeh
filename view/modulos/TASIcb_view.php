...
<ul class="list-group">
 ...
 <li >Evalúa tecnologías de hardware para soportar aplicaciones de manera efectiva.
 ...
 <li >Analizar problemas dentro de una empresa e instituciones públicas y privadas para darle solución mediante tecnologia móvil.</li>

 <li >Desarrollar base de datos locales y en la nube para el proceso de información desde aplicaciones móviles.</li>

 <li >Aplicar lenguajes de programación para desarrollar aplicaciones moviles según la evolución de software y hardware.</li>

 <li >Aplicar metodologías y tecnologías emergentes para el desarrollo de aplicaciones móviles.</li>

 <li >Aplicar tecnologías y algoritmos de seguridad para la integridad de los datos.</li>

 <li >Identificar y aplicar técnicas para el marketing y publicación de los productos o servicios con las tecnologías actuales.</li>
</ul>
</div>
 </div>
